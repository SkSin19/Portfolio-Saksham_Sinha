...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="py-32 bg-[#050508]/40 border-t border-white/5 relative">
                ...
                <div className="grid lg:grid-cols-12 gap-12">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-6">
                            <h3 className="text-xl font-bold font-mono text-white mb-2">// DIRECTORIES</h3>
                    ...
                    >
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6 font-mono text-xs">
                            <div className="flex flex-col gap-2">
                                <label className="text-white/60 tracking-wider">IDENTIFICATION (NAME)</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-white/60 tracking-wider">COMMS CHANNEL (EMAIL)</label>
                                <input
                                    type="email"
                                    required
